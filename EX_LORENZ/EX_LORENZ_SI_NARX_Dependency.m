...
elseif WORKING == 1
    figpath = ['/Users/ekaiser/Documents/Academia/Papers/KaKuBr_SINDYc-MPC/WORKING/FIGURES/EX_',SystemModel,'_Dependencies/NARX/',TrainAlg,'/']; mkdir(figpath) % !!!!!!!!!!! TL
    datapath = ['/Users/ekaiser/Documents/Academia/Papers/KaKuBr_SINDYc-MPC/WORKING/DATA/EX_',SystemModel,'_Dependencies/NARX/',TrainAlg,'/']; mkdir(datapath)
...
save(fullfile(datapath,['EX_LOTKA_SI_',ModelName,'_',InputSignalType,'_BEST_MODELS_LIST',PostName,'.mat']),'BestModelsList')
end
