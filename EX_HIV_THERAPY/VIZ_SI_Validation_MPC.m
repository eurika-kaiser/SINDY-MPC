...
plot([t;t_valid(2:end-1)],uval.*ones(size([t;t_valid(2:end-1)])),'-k','LineWidth',0.5);
ph(4) = plot([t;t_valid(2:end-1)],u_data,'-k','LineWidth',1);
ph(1) = plot([t;tA(2:end)],[x(:,1);xA(2:end,1)],'-','Color',ccolors(1,:),'LineWidth',1);
ph(2) = plot([t;tA(2:end)],[x(:,2);xA(2:end,2)],'-','Color',ccolors(2,:),'LineWidth',1);
ph(3) = plot([t;tA(2:end)],[x(:,3);xA(2:end,3)],'-','Color',ccolors(3,:),'LineWidth',1);
plot([t],zeros(length([t]),1),'-k','LineWidth',0.5)
...
pt(1) = plot([t;tA(2:end)],[x(:,1);xA(2:end,1)],'-','Color',ccolors(1,:),'LineWidth',1,'Parent',ax2); 
hold on
...
% end
for jM = 1:Nmodels
    ph(jM) = plot([t;tA(2:end)],ones(length([t;tA(2:end)]), 1),'-.','Color',ModelColors(2,:,jM),'LineWidth',1);
end
% set(gca,'xlim',[0 max(tHistory)],'ylim',[0 2])
set(gca,'xlim',[0 max(tA)],'ylim',[0 2])
...
% set(gca,'xlim',[0 max(tHistory)],'ylim',[0 2])
ph(1) = plot([t;tA(2:end)],ones(length([t;tA(2:end)]), 1),'-','Color',ccolors(1,:),'LineWidth',2);
ph(2) = plot([t;tA(2:end)],ones(length([t;tA(2:end)]), 1),'-','Color',ccolors(2,:),'LineWidth',2);
ph(3) = plot([t;tA(2:end)],ones(length([t;tA(2:end)]), 1),'-','Color',ccolors(3,:),'LineWidth',2);
ph(4) = plot([t;tA(2:end)],ones(length([t;tA(2:end)]), 1),'-','Color','k','LineWidth',2);
set(gca,'xlim',[0 max(tA)],'ylim',[0 2])
